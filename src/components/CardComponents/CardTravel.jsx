...
export const CardTravel = () => {
  return (
    <Box padding={"12px"} border="1px solid red" w="350px"
    h="450px"
...
word-spacing="0px"
Font being Rendered="circularairpro-bold 100.0%"
    // fontFamily={}
    fontWeight={"600"}>
    {/* <Text>Travel and Learn with Tripoto's Mindful Retreats</Text> */}
      ...
      <HStack>
        <Text  variant="solid"  margin={"2px 0"}
        textAlign="left"
fontSize={"22px"}
padding="0px"
        >
     ...
     <HStack> <Image  w="20px" h="20px"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTQ_CDpHaWoxmGTSpLbBy_GElYmSHCzCAYvQ&usqp=CAU"></Image>
        <Text color="teal">NorthenEast Inbdian</Text></HStack>

        <Tag size="lg" colorScheme="teal"
        variant="solid" borderRadius="full" color="white">
      ...
      <Flex>
       <Text color="blue ">Logo</Text>
        ...
        <Image margin="5px" w="20px" h="20px" src="https://i.pinimg.com/736x/9b/13/b0/9b13b0a9206c8c046c55dca5edcb3ce8.jpg"></Image>
      </Flex>
    </Box>
  );
};
